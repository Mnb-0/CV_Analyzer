...
class CVAnalyzerApp:
    ...
    # --- THREADING FUNCTIONS (REVERTED TO SINGLE THREAD) ---
    ...
    # --- REVERTED TO SEQUENTIAL (SINGLE THREAD) ---
    ...
    def update_performance_chart(self):
        ...
        style = ttk.Style()
        bar_color = 'blue' # <-- FIX: Cast to string
    ...
    def export_single_report(self):
        ...
        try:
            ...
            report_content += "-"*60 + "\n"
            for result in self.performance_data:
                report_content += f"{result['name']:<25} | {result['time']:.4f} | {result['comparisons']:,<15}\n"
...
if __name__ == "__main__":
    # --- IMPORTANT: Reverted to simple mainloop ---
    # No ProcessPoolExecutor, no 'if __name__' guard needed for spawn
    root = tk.Tk()
